...
/*   Updated: 2021/01/29 11:33:43 by rsanchez         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_vector	get_x_rotation(t_vector *vec, double theta)
{
	double		coss;
	double		sinn;
	t_vector	temp;
...
t_vector	get_y_rotation(t_vector *vec, double theta)
{
	double		coss;
	double		sinn;
	t_vector	temp;
...
t_vector	get_z_rotation(t_vector *vec, double theta)
{
	double		coss;
	double		sinn;
	t_vector	temp;
